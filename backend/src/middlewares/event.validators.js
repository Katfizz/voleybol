...
const eventCreationValidation = [
    ...
    check('categoryIds', 'Debes proporcionar un arreglo de IDs de categorías').optional().isArray(),
    check('categoryIds.*', 'Cada ID de categoría debe ser un número').optional().isInt(),
